...
namespace Business
{
    class Y_015
    {
        ...
        public Y_015(String txid, String connectionString, String a, String b, String c, String d, String e, String f,
            ...
            String s, String t, String u, String v, String w, String loginAc)
        {
            this.TXID = txid;
            dberr = new Data.Dber();
            //this.cusNo = loginAc;
            
            if (processTransaction(connectionString, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, loginAc) != 0)
            {
                this.error = true;
            }
            ...
            String s, String t, String u, String v, String w, String loginAc)
        {
            ...
            if (loginAc.Equals("0") || loginAc.Equals(" "))
            {
