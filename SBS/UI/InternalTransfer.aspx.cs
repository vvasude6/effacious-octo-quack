    ...
    public partial class InternalTransfer : System.Web.UI.Page
    {
        ...
        protected void Transfer_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var output = new Business.XSwitch(Global.ConnectionString, FromDropDown.SelectedValue, string.Format("014|{0}|{1}|{2}",FromDropDown.SelectedValue, ToDropDown.SelectedValue, transferAmount));
